      ...
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 pb-16 border-b border-white/10">
          ...
          <div className="md:col-span-2 flex flex-col gap-4">
            ...
            <nav className="flex flex-col gap-3.5 text-sm font-light">
              <Link
                href="/daftar?service=sensory"
                className="hover:text-white transition-colors duration-300"
              >
                Daycare Harian
              </Link>
              <Link
                href="/daftar?service=speech"
                className="hover:text-white transition-colors duration-300"
              >
                PAUD Terintegrasi
              </Link>
              <Link
                href="/daftar?service=psychology"
                className="hover:text-white transition-colors duration-300"
              >
                Biro Psikologi
              </Link>
              <Link
                href="/daftar?service=motoric"
                className="hover:text-white transition-colors duration-300"
              >
                Program Parenting
              </Link>
              <Link
                href="/daftar?service=social"
                className="hover:text-white transition-colors duration-300"
              >
                Kelas Gymnastic
              </Link>
              <Link
                href="/daftar?service=parenting"
                className="hover:text-white transition-colors duration-300"
              >
                Aviary
              </Link>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-start gap-3">
                ...
                <span className="leading-relaxed text-white/70">
                  Jl. Kinibalu no.17 Palangkaraya
                </span>
              </div>
              <div className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="hover:text-white transition-colors duration-300 text-white/70"
                >
                  (021) 555-1234
                </a>
              </div>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-light text-white/55">
          <p>
            © {new Date().getFullYear()} Gentala Child Development Center. Hak
            Cipta Dilindungi.{" "}
            <Link
              href="/admin/login"
